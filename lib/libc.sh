...
./clang ${array[@]} -O3 -c -emit-llvm -nostdinc -nostdlib -fno-builtin -isystem ../../lib/musl/src/internal -isystem ../../lib/abalib -I ../../lib/musl/include -Dsyscall=#error -DCURRENT_LOCALE=UTF8_LOCALE -DCURRENT_UTF8=1 -Wno-unknown-pragmas -Wno-shift-op-parentheses -Wno-dangling-else -Wno-bitwise-op-parentheses
